...
export function CompanyLoginPage() {
  ...
  useEffect(() => {
    console.log('CompanyLoginPage state:', { user, authLoading, company });
      ...
      <div className="flex flex-col min-h-screen px-4 py-8">
        <div className="w-full max-w-md mx-auto flex-1 flex flex-col justify-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-center">Sign in to your company account</p>
          </div>
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            ...
            <Link to="/company/signup" className="text-gray-900 font-medium hover:underline">
              Sign up
            </Link>
          </p>
